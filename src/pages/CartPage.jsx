    ...
    <div className="min-h-screen tone-base text-[#261b17]">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-18 pt-10 sm:px-6 md:pb-28 md:pt-16">
        <section className="max-w-3xl">
          ...
          <p className="mt-6 text-sm leading-8 text-[#66524f] md:text-base">
        ...
        <section className="mt-10">
          {cartItems.length === 0 ? (
            <div className="tone-card rounded-[2rem] p-8 md:p-10">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-8 text-[#66524f]">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
              <div>
                <div className="tone-low mb-6 flex flex-col gap-4 rounded-[1.8rem] p-5 md:flex-row md:items-center md:justify-between md:p-6">
                  <div>
                    <div className="text-sm text-[#66524f]">当前商品</div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link
                      to="/shop"
                      className="rounded-full bg-[rgba(255,251,247,0.86)] px-4 py-2 text-sm text-[#241914] shadow-[inset_0_0_0_1px_rgba(111,39,53,0.12)]"
                    >
                      继续浏览
                    </Link>
                    <button
                        ...
                        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                          <div className="flex gap-4">
                            ...
                            <div>
                              ...
                              <p className="mt-2 text-sm text-[#66524f]">单价：{item.price}</p>
                              <p className="mt-1 text-sm text-[#66524f]">分类：{item.category}</p>
                              <Link
                                to={`/product/${item.id}`}
                          ...
                          <div className="flex flex-col items-start gap-4 md:items-end">
                            <div className="text-left md:text-right">
                              <div className="text-sm text-[#66524f]">小计</div>
                            ...
                            <div className="flex items-center rounded-full bg-[rgba(255,251,247,0.82)] px-2 py-2 shadow-[inset_0_0_0_1px_rgba(111,39,53,0.12)]">
                              <button
                                className="h-10 w-10 rounded-full text-sm text-[#66524f]"
                            ...
                            <button
                              className="rounded-full bg-[rgba(111,39,53,0.1)] px-4 py-2 text-sm text-[#241914]"
              ...
              <aside className="tone-low h-fit rounded-[2rem] p-6">
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center justify-between text-sm text-[#66524f]">
                    <span>商品件数</span>
                ...
                <div className="tone-card mt-6 rounded-[1.35rem] p-4">
                  <div className="text-[11px] uppercase tracking-[0.18em] text-[#98827e]">说明</div>
                  <p className="mt-2 text-sm leading-7 text-[#66524f]">
