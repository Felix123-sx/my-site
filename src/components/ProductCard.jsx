  ...
  return (
    <article className="soft-tonal-card group rounded-[1.6rem] p-4 sm:p-5 hover-panel home-card-tilt reveal-up">
      ...
      <div className="mt-5">
        ...
        <h3 className="font-editorial mt-4 text-[1.6rem] font-semibold leading-none text-[var(--ui-title)] sm:text-[1.9rem] text-shift-soft">
          {product.name}
        </h3>
      ...
      <div className="mt-6 flex items-end justify-between gap-4">
        <div>
          <div className="text-[11px] uppercase tracking-[0.2em] text-[var(--ui-kicker)]">价格</div>
